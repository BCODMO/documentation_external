...
# documentation.
# link to sphinx theme configuration options: https://sphinx-rtd-theme.readthedocs.io/en/stable/configuring.html#miscellaneous-options
...
html_logo = 'nstatic/pic_logo_bcodmo1.png'
